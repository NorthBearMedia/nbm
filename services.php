...
?>
    ...
    <section class="services-hero">
        <div class="container">
            <h1 class="services-title slide-up">Our Services</h1>
            <p class="services-subtitle fade-in">At Steve Musk Engineering, we provide complete mechanical and process engineering solutions. From design to fabrication and installation, our expertise ensures precision, efficiency, and reliability in every project.</p>
        </div>
    </section>
    ...
    <section class="services-grid-section">
        <div class="container">
            <div class="services-card-grid">
                ...
                <a href="/services/design.php" class="service-card service-card-link slide-up stagger-1">
                ...
                <a href="/services/skids.php" class="service-card service-card-link slide-up stagger-2">
                ...
                <a href="/services/vessels.php" class="service-card service-card-link slide-up stagger-3">
                ...
                <a href="/services/fabrications.php" class="service-card service-card-link slide-up stagger-4">
                ...
                <a href="/services/installation.php" class="service-card service-card-link slide-up stagger-5">
                ...
                <a href="/services/turnkey.php" class="service-card service-card-link slide-up stagger-6">
                ...
                <a href="/services/welding.php" class="service-card service-card-link slide-up stagger-7">
