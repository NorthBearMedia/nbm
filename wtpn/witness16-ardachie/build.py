...
blocks = [
 ...
 ("card", card("q1", C["q1"]), 1.5, None, 0),
 ("voice", "a_s1", alen("a_s1") + 0.5, D / "../ep45-sauchie/s6-house-night.jpg", 0.15),
 ("card", card("q2", C["q2"]), 1.5, None, 0),
 ("voice", "a_s2", alen("a_s2") + 0.5, None, 0.15),
 ("card", card("q3", C["q3"]), 1.5, None, 0),
 ("voice", "a_s3", alen("a_s3") + 0.6, D / "../ep46-renvyle/s3-corridor.jpg", 0.15),
 ("card", card("q4", C["q4"]), 1.5, None, 0),
 ("voice", "a_s4", alen("a_s4") + 0.5, None, 0.15),
 ("card", card("t4", C["t4"]["big"]), 2.4, None, 0),
 ("voice", "a_s5", alen("a_s5") + 0.8, None, 0.15),
 ("card", card("t5", C["t5"]["big"]), 2.4, None, 0),
...
for i, (w, s, e) in enumerate(w3):
    if w.lower().startswith("crawling"):
        sting_t = marks["a_s3"] + s - 0.3; break
